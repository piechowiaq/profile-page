        ...
        <div class="container max-w-screen-xl mx-auto px-4">
            ...
            <div class="text-center">
                <div class="flex justify-center mb-16">
                    <img :src=profile alt="Logo" class="object-contain h-56 w-56 rounded-b-lg grayscale ">
